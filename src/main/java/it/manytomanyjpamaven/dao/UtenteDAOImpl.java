...
public class UtenteDAOImpl implements UtenteDAO {
	...
	public List<Utente> findAllCreatedInMonthAndYear(int mese, int anno) {
		TypedQuery<Utente> query = entityManager.createQuery(
				"from Utente u where month(u.dateCreated) = :mese and year(u.dateCreated)= :anno", Utente.class);
	...
	public Long countUtentiWithRuoloAdmin() {
		...
		Query query = entityManager
				.createQuery("select count(u.id) from Utente u join u.ruoli r where r.codice like 'ROLE_ADMIN'");
